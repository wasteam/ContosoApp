...
namespace AppStudio.Common.Commands
{
    ...
    public static class ItemClickCommand
    {
        ...
        /// </summary>
        /// <param name="d">The dependency object to assign the command.</param>
        ...
        /// </summary>
        /// <param name="d">The dependency object to query.</param>
        ...
        /// </summary>
        /// <param name="d">The dependency object changed.</param>
